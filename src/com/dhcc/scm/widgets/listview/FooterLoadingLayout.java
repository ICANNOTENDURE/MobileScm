 ...
 */
package com.dhcc.scm.widgets.listview;
...
public class FooterLoadingLayout extends LoadingLayout {
	...
	private void init(Context context) {
		...
		strRefreshing = context.getString(R.string.pull_to_refresh_header_hint_loading);
		strReleaseToRefresh = context.getString(R.string.pull_to_refresh_header_hint_ready);
		strPullToRefresh = context.getString(R.string.pull_to_refresh_header_hint_normal);
	}

	@Override
	protected View createLoadingView(Context context, AttributeSet attrs) {
		View container = View.inflate(context, R.layout.pull_to_load_footer, null);
		return container;
	}
