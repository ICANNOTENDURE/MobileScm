...
import com.dhcc.scm.http.HttpHeaderParser;
import com.dhcc.scm.http.KJHttpException;
import com.dhcc.scm.http.NetworkResponse;
import com.dhcc.scm.http.Request;
import com.dhcc.scm.http.Request.HttpMethod;
import com.dhcc.scm.http.Request.Priority;
import com.dhcc.scm.http.Response;
    ...
    public Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
        synchronized (sDecodeLock) {
            try {
                ...
                Loger.debug("Caught OOM for %d byte image, url=%s",
